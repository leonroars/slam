...
public class SeatUnitTest {
    ...
    void shouldThrowBusinessRuleViolationException_WhenSeatNumberBelowZero() {
        ...
        // when & then
        assertThatThrownBy(() -> Seat.create(1L, belowMinSeatNumber, 1000, SeatStatus.AVAILABLE))
    ...
    void shouldThrowBusinessRuleViolationException_WhenSeatNumberOverMax() {
        ...
        // when & then
        assertThatThrownBy(() -> Seat.create(1L, overMaxSeatNumber, 1000, SeatStatus.AVAILABLE))
                .isInstanceOf(BusinessRuleViolationException.class);
    }
    ...
    void shouldSucceed_WhenSeatNumberIsLegal() {
        ...
        assertThatNoException().isThrownBy(
                () -> Seat.create(1L, legalSeatNumber, 1000, SeatStatus.AVAILABLE));
    }
