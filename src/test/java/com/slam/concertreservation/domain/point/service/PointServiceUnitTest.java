...
class PointServiceUnitTest {
        ...
        class PointUsageUnitTest {
                ...
                void shouldSuccessDecreasingUserPointBalance_WhenUserExistsAndProperAmountDecreased() {
                        ...
                        UserPointBalance userPointBalance = UserPointBalance.create(userId,
                                        Point.create(currentBalance));
                        UserPointBalance expected = UserPointBalance.create(userId,
                                        Point.create(currentBalance - decreaseAmount));
        ...
        class PointChargeUnitTest {
                ...
                void shouldSuccessIncreasingUserPointBalance_WhenUserExistsAndProperAmountIncreased() {
                        ...
                        UserPointBalance userPointBalance = UserPointBalance.create(userId,
                                        Point.create(currentBalance));
                        UserPointBalance expected = UserPointBalance.create(userId,
                                        Point.create(currentBalance + increaseAmount));
        ...
        class PointHistoryUnitTest {
                ...
                void shouldCreateAndSavePointHistory_WhenTheLegalChargeAttemptIsProcessed() {
                        ...
                        UserPointBalance expectedBalance = UserPointBalance.create(userId,
                                        Point.create(currentBalance + increaseAmount));
                        PointHistory expectedPointHistory = PointHistory.create(userId, PointTransactionType.CHARGE,
                                        increaseAmount);
